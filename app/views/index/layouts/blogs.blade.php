...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="col-md-12">
            <button data-toggle="modal" data-target="#insert" type="button" class="btn btn-outline btn-success" style="float: right;margin-bottom: 1%;width: 17%;">Yeni Kategori Ekle</button>
        </div>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <form action="/ypanel/blog/categories/insert" method="post">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <p class="lead">Kategori Description (SEO) : <br>
